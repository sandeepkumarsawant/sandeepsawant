        ...
        this.users.forEach(user => {
            ...
            userItem.innerHTML = `
                ...
                <div class="user-actions">
                    <div style="color: var(--primary); font-weight: 600; text-transform: uppercase; margin-bottom: 0.5rem;">${user.role}</div>
                    <button class="btn-delete-user" onclick="adminPanel.deleteUser('${user.email}')">Delete User</button>
                </div>
            `;
